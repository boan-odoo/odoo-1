...
class Currency(models.Model):
    ...
    def _view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        arch, view = super(Currency, self)._view_get(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
...
class CurrencyRate(models.Model):
    ...
    @api.model
    def _view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        arch, view = super(CurrencyRate, self)._view_get(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
