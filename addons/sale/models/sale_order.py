...
class SaleOrder(models.Model):
    ...
    def _send_order_confirmation_mail(self):
        ...
        if mail_template:
            for order in self:
                order.with_context(force_send=True).message_post_with_template(mail_template.id, composition_mode='comment', email_layout_xmlid="mail.mail_notification_paynow")
