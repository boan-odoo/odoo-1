...
class ProductTemplate(models.Model):
    ...
    def _get_combination_info(self, combination=False, product_id=False, add_qty=1, pricelist=False, parent_combination=False, only_template=False):
        ...
        if product:
            ...
            list_price = product.price_compute('list_price', pricelist=pricelist)[product.id]
            if pricelist:
            ...
            list_price = product_template.price_compute('list_price', pricelist=pricelist)[product_template.id]
            if pricelist:
