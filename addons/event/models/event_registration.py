...
class EventRegistration(models.Model):
    ...
    def write(self, vals):
        ...
        # Event(Ticket) models constraints. Removing duplicates.
        if confirming:
    ...
    def toggle_active(self):
        ...
        if pre_inactive:
            pre_inactive.mapped('event_id')._check_seats_availability()
            pre_inactive.mapped('event_ticket_id')._check_seats_availability()

    def _check_auto_confirmation(self):
        """ Checks that all registrations are for `auto-confirm` events. """
        return self.mapped('event_id.auto_confirm') == [True]
