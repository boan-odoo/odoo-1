...
class TestSMSMailingABTesting(MassSMSCommon, TestMailingABTesting):
    ...
    def test_ab_testing_sms(self):
        ...
        ab_testing_sms_mailing = self.env['mailing.mailing'].create({
        ...
        # Checks ab_testing_sms_count, it should be eyaul to the number of version created for a/b testing
        self.assertEqual(self.ab_testing_sms_mailing_1.ab_testing_sms_count, 2)
