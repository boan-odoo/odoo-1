...
class HrContract(models.Model):
    ...
    def _get_contract_work_entries_values(self, date_start, date_stop):
        ...
        # Map resources per calendar
        contract_per_calendar = defaultdict(lambda: self.env['hr.contract'])
        for contract in self:
            contract_per_calendar[contract.resource_calendar_id] |= contract
        ...
        for calendar, contracts in contract_per_calendar.items():
            ...
            for contract in contracts:
                ...
                attendances = attendances_batch[resource.id]
