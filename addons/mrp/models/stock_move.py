...
class StockMove(models.Model):
    ...
    manual_consumption = fields.Boolean('Manual Consumption',
        compute='_compute_manual_consumption', store=True,
    ...
    def _compute_manual_consumption(self):
        for move in self:
            if move.state == 'draft':
                move.manual_consumption = move.bom_line_id.manual_consumption
    ...
    def create(self, vals_list):
        ...
        - Backorders
        """
        if self.env.context.get('from_show_details_wizard'):
    ...
    def action_show_details(self):
        ...
        if self.raw_material_production_id:
            ...
            action['context']['from_show_details_wizard'] = True
