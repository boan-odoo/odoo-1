...
class AccountMove(models.Model):
    ...
    def action_create_batch_qr(self):
    ...
    def l10n_ch_action_print_qr(self):
        ...
        for invoice in self:
            ...
            try:
                ...
                invoice.partner_bank_id._eligible_for_qr_code('ch_qr', invoice.partner_id, invoice.currency_id, raises_error=True)
                qr_inv |= invoice
                ...
                if invoice.l10n_ch_isr_valid:
                    ...
                    classic_inv |= invoice
                    error_messages[invoice.id] = e.name
        ...
        if classic_inv or isr_inv:
            return {
                ...
                'view_type': 'form',
                'view_mode': 'form',
                'view_id ref="l10n_ch.qr_invoice.wizard.form"': '',
                'target': 'new',
                'context': {
        ...
        return self.action_create_batch_qr()
