...
class TestAccountMoveReconcile(AccountTestInvoicingCommon):
    ...
    def test_reconcile_exchange_difference_on_partial_same_foreign_currency_debit_expense(self):
        currency = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_same_foreign_currency_debit_income(self):
        currency = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_same_foreign_currency_credit_expense(self):
        currency = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_same_foreign_currency_credit_income(self):
        currency = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_one_foreign_currency_debit_expense(self):
        comp_curr = self.company_data['currency']
        foreign_curr = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_one_foreign_currency_debit_income(self):
        comp_curr = self.company_data['currency']
        foreign_curr = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_one_foreign_currency_credit_expense(self):
        comp_curr = self.company_data['currency']
        foreign_curr = self.currency_data['currency']
    ...
    def test_reconcile_exchange_difference_on_partial_one_foreign_currency_credit_income(self):
        comp_curr = self.company_data['currency']
        foreign_curr = self.currency_data['currency']
