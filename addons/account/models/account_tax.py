...
class AccountTax(models.Model):
        ...
        for tax in taxes:
            ...
            for repartition_line, line_amount in zip(tax_repartition_lines, repartition_line_amounts):
                ...
                taxes_vals.append({
                    ...
                    'account_id': repartition_line._get_business_tax_account().id,
    ...
    @api.model
    def _prepare_base_line(self, base_line,
    ...
    @api.model
    def _prepare_tax_line(self, tax_line,
    ...
    @api.model
    def _get_tax_grouping_key_from_base_line(self, line_vals, tax_vals):
        """ Take a tax results returned by the taxes computation method and return values in order to create
        to aggregate taxes together.

        :param line_vals:   A python dict returned by '_prepare_base_line'.
        :param tax_vals:    A python dict returned by 'compute_all' under the 'taxes' key.
        :return:            A python dict.
        """
        tax_repartition_line = self.env['account.tax.repartition.line'].browse(tax_vals['tax_repartition_line_id'])
        tax_account = tax_repartition_line._get_business_tax_account() or line_vals['account']
        return {
    ...
    @api.model
    def _get_tax_grouping_key_from_tax_line(self, line_vals):
        ...
        :param line_vals:   A python dict returned by '_prepare_tax_line'.
    ...
    def _compute_taxes(self, base_lines, tax_lines=None,
        ...
        for line_vals in base_lines:
            ...
            if taxes:
                ...
                for tax_res in taxes_res['taxes']:
                    grouping_dict = self._get_tax_grouping_key_from_base_line(line_vals, tax_res)
        ...
        for line_vals in tax_lines or []:
            grouping_key_str = _serialize_python_dictionary(self._get_tax_grouping_key_from_tax_line(line_vals))
            ...
            if grouping_key_str in existing_tax_line_map:
                ...
                existing_tax_line_map[grouping_key_str] = line_vals
        ...
        for grouping_key_str, tax_values in base_line_map.items():
            ...
            if grouping_key_str in existing_tax_line_map:
                ...
                line_vals = existing_tax_line_map.pop(grouping_key_str)
    ...
    def _prepare_tax_totals_json(self, base_lines, partner, currency, tax_lines=None, handle_price_include=True, include_caba_tags=False):
