...
class MailThread(models.AbstractModel):
    ...
    def _notify_cancel_by_type_std(self, notification_type):
    ...
    def _notify_cancel_email(self):
        self._notify_cancel_by_type_std('email')

    @api.model
    def notify_cancel_by_type(self, notification_type):
        """ Subclasses must call this method and then
         * either call the standard implementation _notify_cancel_by_type_std
