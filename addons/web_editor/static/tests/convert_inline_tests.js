...
QUnit.module('convert_inline', {}, function () {
    ...
    QUnit.test('convert a single-row regular grid', async function (assert) {
        ...
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(1, 1, 12, 100, true),
            "should have converted a 1x1 grid to an equivalent table");

        // 1x2
        $editable = $(`<div>${getRegularGridHtml(1, 2)}</div>`);
        convertInline.bootstrapToTable($editable);
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(1, 2, 6, 50, true),
            "should have converted a 1x2 grid to an equivalent table");

        // 1x3
        $editable = $(`<div>${getRegularGridHtml(1, 3)}</div>`);
        convertInline.bootstrapToTable($editable);
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(1, 3, 4, 33.33, true),
            "should have converted a 1x3 grid to an equivalent table");

        // 1x12
        $editable = $(`<div>${getRegularGridHtml(1, 12)}</div>`);
        convertInline.bootstrapToTable($editable);
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(1, 12, 1, 8.33, true),
    ...
    QUnit.test('convert a single-row regular overflowing grid', async function (assert) {
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(1, 12, 1, 8.33, true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 12)</td></tr></table>`,
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(1, 12, 1, 8.33, true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="1" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 12)</td>` +
                `<td colspan="11" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 13)</td></tr></table>`,
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(1, 12, 1, 8.33, true).slice(0, -8) +
            getRegularTableHtml(1, 12, 1, 8.33, true).replace(/\(0, (\d+)\)/g, (s, c) => `(0, ${+c + 12})`)
                .replace(/^<table[^<]*>/, '').slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 24)</td></tr></table>`,
        ...
        assert.strictEqual(removeComments($editable.html()),
            ...
            getRegularTableHtml(1, 12, 1, 8.33, true).replace(/\(0, (\d+)\)/g, (s, c) => `(0, ${+c + 12})`)
                .replace(/^<table[^<]*>/, '').slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="1" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 24)</td>` +
                `<td colspan="11" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 25)</td></tr></table>`,
    ...
    QUnit.test('convert a multi-row regular grid', async function (assert) {
        ...
        convertInline.bootstrapToTable($editable);
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(2, 1, 12, 100, true),
        ...
        convertInline.bootstrapToTable($editable);
        assert.strictEqual(removeComments($editable.html()), getRegularTableHtml(3, 3, 4, 33.33, true),
    ...
    QUnit.test('convert a multi-row regular overflowing grid', async function (assert) {
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(1, 12, 1, 8.33, true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(0, 12)</td></tr>` +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(1, 0)</td></tr></table>`,
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(2, [1, 12], [12, 1], [100, 8.33], true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(1, 12)</td></tr></table>`,
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(2, [1, 12], [12, 1], [100, 8.33], true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(1, 12)</td></tr>` +
                getRegularTableHtml(1, 6, 2, 16.67, true).replace(/\(0,/g, `(2,`).replace(/^<table[^<]*>/, ''),
        ...
        assert.strictEqual(removeComments($editable.html()),
            getRegularTableHtml(3, [1, 6, 12], [12, 2, 1], [100, 16.67, 8.33], true).slice(0, -8) +
                `<tr style="width: 100%;"><td colspan="12" width="100%" style="width: 100%; display: inline-block;" class="mso-hide">(2, 12)</td></tr></table>`,
