...
export class Powerbox {
    ...
    render(commands) {
        if (this.options.commandFilters && this.options.commandFilters.length) {
            /**
             * Some available commands may need to be disabled in certain situations.
             * i.e.: in a knowledge article, prevent the usage of the /template command inside a /template block
             * commandFilters is an array of functions which returns what commands can be used
             */
