        ...
        if (backgroundURL) {
            ...
            if (parts.gradient) {
                ...
                if (parts.gradient && defaultParts.gradient && weUtils.areCssValuesEqual(parts.gradient, defaultParts.gradient)) {
                    ...
                    wasDefaultGradient = true;
                }
            }
        }
        let combined = backgroundImagePartsToCss(parts);
        if (combined === 'none' && wasDefaultGradient) {
            // Do not hide default gradient.
            combined = '';
        }
        this.$target.css('background-image', combined);
    },
