...
class ProjectUpdate(models.Model):
    ...
    def _get_services_values(self, project):
        ...
        sols = project._get_service_sale_order_lines()
    ...
    def _get_profitability_values(self, project):
        ...
        if not (self.user_has_groups('project.group_project_manager') and costs_revenues):
            return {}
        profitability_items = project._get_profitability_items()
        ...
        return {
            ...
            'costs': format_amount(self.env, -costs, project.currency_id),
            'revenues': format_amount(self.env, revenues, project.currency_id),
            'margin': margin,
