...
class ImLivechatChannelRule(models.Model):
    ...
    action = fields.Selection([
        ...
        ('auto_popup', 'Autopop LiveChat Button'),
        ('use_chatbot', 'Use a Chatbot'),
    ...
    auto_popup_timer = fields.Integer('Auto popup timer', default=0,
        help="Delay (in seconds) to automatically open the conversation window. Note: the selected action must be 'Auto popup' or 'Chatbot' otherwise this parameter will not be taken into account.")
