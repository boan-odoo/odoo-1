...
class TestUBLBE(TestUBLCommon):
    ...
    def test_invoice_edi_pdf(self):
        ...
        self.assertEqual(invoice.amount_total, 225.67)
    ...
    def test_invoice_export_import_xml(self):
        """
        Test whether the elements only specific to ubl_de are correctly exported
        ...
        # Export: BuyerReference is not in the out_invoice xml
        self.assertIsNone(xml_etree.find('{*}BuyerReference'))
        self.assertEqual(
