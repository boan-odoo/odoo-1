...
class TestUBLDE(TestUBLCommon):
    ...
    def test_invoice_edi_pdf(self):
        ...
        self.assertEqual(invoice.amount_total, 1586.20)
    ...
    def test_invoice_export_import_xml(self):
        ...
        # Import: BuyerReference is correctly imported from the out_invoice xml
        # In fact, no need to import the info of the customer because he is the one importing the invoice
