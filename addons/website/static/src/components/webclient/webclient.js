...
patch(WebClient.prototype, 'website_web_client', {
    setup() {
        ...
        useEffect(() => {
            this.fullscreenState.isFullscreen = !!this.websiteContext.edition;
            this.el.closest('body').classList.toggle('o_website_fullscreen', this.fullscreenState.isFullscreen);
