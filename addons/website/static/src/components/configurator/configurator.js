...
class DescriptionScreen extends Component {
    ...
    /**
     * Called each time the autocomplete input's value changes. Only industries having
     * a label or a synonym containing all terms of the input value are keps.
     * The order received from IAP is kept (expected to be on descending hit count) unless
     * there are 7 or less matches in which case the results are sorted alphabetically.
