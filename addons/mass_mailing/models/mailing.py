...
class MassMailing(models.Model):
    ...
    def _compute_favorite_date(self):
        for mailing in self:
            if mailing.favorite and not mailing.favorite_date:
                mailing.favorite_date = fields.Datetime.now()
            elif not mailing.favorite:
                mailing.favorite_date = False
    ...
    def action_set_favorite(self):
        ...
        if any(mailing.is_body_empty for mailing in self):
            return {
